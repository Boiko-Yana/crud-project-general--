            ...
            <div class="cols">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <p><a class="btn btn-primary" role="button">View JDBC &raquo;</a></p>
                    </div>
                    <div class="col-lg-4">
                        <img class="img-rounded" src="${pageContext.request.contextPath}/resources/img/hider.png" alt="hibernate logo" width="140" height="140">
